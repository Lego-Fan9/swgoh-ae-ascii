...
export type asciifyCallback = (err: Error, asciified: string | string[]) => void;

export type asciifyImageInput = string | Buffer | URL;

export function asciify(image: asciifyImageInput, options?: asciifyOptions, callback?: asciifyCallback): Promise<string | string[]>;

export function setChars(input: string);